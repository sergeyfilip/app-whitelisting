...
if ($form_type === 'edit') {
    $form = 'whitelisting/policy_list/add_edit_policy/edit/' . $policy_no;
    $buttons = array(
        form_submit_update('submit'),
        anchor_cancel('/app/whitelisting/policy_list')
    );
} else {
    $form = 'whitelisting/policy_list/add_edit_policy/add';
    $buttons = array(
...
echo form_open($form);
echo form_header('Policy');

echo field_input('policy_name', $policy['name'], 'Policy Name');
